      ...
      <SafeAreaView className="flex-1">
        <View>
          ...
          <View className="items-center px-6 mt-4">
            <Image
              source={require('@/assets/im/auth.png')}
              style={{ width: 320, height: 350 }}
              contentFit="cover"
            />
          </View>
          {/* feature chips */}
          <View className="flex-row flex-wrap justify-center gap-3 px-3 mb-10">
            {[
              {
        ...
        <View className="px-8 pb-4">
          ...
          <View className="flex-row justify-center items-center gap-4 mb-5">
            ...
            <Pressable
              ...
              onPress={() =>
                !isLoading && handleSocialAuth(LoadingStrategy.Google)
              }
            >
              {loadingStrategy === LoadingStrategy.Google ? (
                <ActivityIndicator size={'small'} color={'#6C5CE7'} />
              ) : (
                <Image
                  source={require('@/assets/im/google.png')}
            ...
            <Pressable
              ...
              onPress={() =>
                !isLoading && handleSocialAuth(LoadingStrategy.Apple)
              }
            >
              {loadingStrategy === LoadingStrategy.Apple ? (
                <ActivityIndicator size="small" color="#6C5CE7" />
              ) : (
            ...
            <Pressable
              ...
              onPress={() =>
                !isLoading && handleSocialAuth(LoadingStrategy.GitHub)
              }
            >
              {loadingStrategy === LoadingStrategy.GitHub ? (
                <ActivityIndicator size="small" color="#6C5CE7" />
              ) : (
